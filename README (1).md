...
*Four ways of turning a population into the next one, at an identical budget of
500,000 games. The ceilings are close together. The floors are not.*
...
*Two populations of unequal size selecting against each other. Top: the win rate
of the larger side. Bottom: what each side scores against the 2015 baseline.*
